...
do_add_scailx_ppa() {
    ...
    for f in ${PACKAGE_ARCHS}; do
        ...
        echo "deb [signed-by=/etc/pki/packagefeed-gpg/PACKAGEFEED-GPG-KEY-scailx-scailx] https://scailx-ppa.org/${DISTRO}/${DISTRO_VERSION}/deb/$f ./" >> ${IMAGE_ROOTFS}${sysconfdir}/apt/sources.list.d/${DISTRO}.list
    done
}

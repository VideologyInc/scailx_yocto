...
do_add_scailx_ppa() {
    ...
    for f in ${PACKAGE_ARCHS}; do
        ...
        echo "deb [signed-by=/etc/pki/scailx-ppa-key.pub.gpg] https://scailx-ppa.org/${DISTRO_VERSION}/deploy/deb/$f ./" >> ${IMAGE_ROOTFS}${sysconfdir}/apt/sources.list.d/${DISTRO}.list
    done
}
